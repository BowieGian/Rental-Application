...
public class SelectionFilterScreenAP extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private static final String TAG = "SelectionFilterScreenAP";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayDate1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(SelectionFilterScreenAP.this,
        ...
        ArrayAdapter<String> myAdaptor = new ArrayAdapter<>(SelectionFilterScreenAP.this,
        ...
        ArrayAdapter<String> myAdaptor2 = new ArrayAdapter<>(SelectionFilterScreenAP.this,
        ...
        ArrayAdapter<String> myAdaptor3 = new ArrayAdapter<>(SelectionFilterScreenAP.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.Rating));
        myAdaptor.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinnerRating.setAdapter(myAdaptor3);

        ArrayAdapter<String> myAdaptor4 = new ArrayAdapter<>(SelectionFilterScreenAP.this,
