    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayDate1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(FilterHouse.this,
        ...
        ArrayAdapter<String> myAdaptor = new ArrayAdapter<>(FilterHouse.this,
        ...
        //Passing the correct array define for each spinner based on their data input
        ArrayAdapter<String> myAdaptor3 = new ArrayAdapter<>(FilterHouse.this,
        ...
        //Passing the correct array define for each spinner based on their data input
        ArrayAdapter<String> myAdaptor4 = new ArrayAdapter<>(FilterHouse.this,
